...
import fr.edencraft.mobregionblocker.content.ConfigContent;
import fr.edencraft.mobregionblocker.content.message.Fr;
...
public class ConfigurationManager {
    ...
    public void setupFiles() {
        ...
        initNewFile("messages", Fr.class.getSimpleName() + ".yml", Fr.CONTENT);
    }
    ...
    private void log(Level level, String message) {
        MobRegionBlocker.getINSTANCE().log(level, message);
    }
